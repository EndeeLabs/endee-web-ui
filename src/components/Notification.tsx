...
const config: Record<NotificationType, {
  ...
  success: {
    icon: GoCheck,
    classes: 'bg-green-50 border-green-200 text-green-700 dark:bg-green-900/20 dark:border-green-800 dark:text-green-300',
  },
  error: {
    icon: GoAlert,
  ...
  warning: {
    icon: GoAlert,
    classes: 'bg-amber-50 border-amber-200 text-amber-700 dark:bg-amber-900/20 dark:border-amber-800 dark:text-amber-300',
  },
  info: {
    icon: GoInfo,
...
export default function Notification({
  ...
  return (
    <div className={`border rounded-md ${compact ? 'px-3 py-2' : 'px-4 py-3'} ${classes} flex items-center justify-between text-sm ${className}`}>
