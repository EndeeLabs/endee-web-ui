    ...
    try {
      ...
      if (isHybrid) {
        ...
        if (searchRequest.sparse_indices && searchRequest.sparse_values) {
          if (searchRequest.sparse_indices.length !== searchRequest.sparse_values.length) {
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3">
          <h1 className="text-2xl font-semibold text-slate-800 dark:text-slate-100">Search Vectors</h1>
          {isHybrid && (
        ...
        <form onSubmit={handleSearch} className="space-y-4">
          ...
          <div>
            <div className='flex items-center gap-2 mb-2'>
              ...
              <Tooltip tip={`Comma-separated numbers (${indexInfo?.dimension ? indexInfo.dimension : 'n'} dimensions)`} />
            </div>
            <input
              type='text'
              value={vector}
            ...
            <div className="flex items-end pb-1">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  disabled={searching}
                />
                <span className="text-sm text-slate-700 dark:text-slate-200">Include vectors in results (dense only)</span>
              </label>
            </div>
          </div>
              ...
              {results.map((result, index) => (
                ...
                >
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {includeVectors && result.vector && result.vector.length > 0 && (
                      <div className="flex gap-2">
